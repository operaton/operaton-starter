...
public final class JtepomxmlGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,2,2,12,12,12,16,16,17,17,19,19,22,22,23,23,24,24,32,32,75,75,75,2,2,2,2};
	public static void render(gg.jte.TemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, ProjectConfig config) {
		...
		jteOutput.writeUserContent(VersionConstants.OPERATON_VERSION);
